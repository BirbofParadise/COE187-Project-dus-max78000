...
# python train.py --epochs 5 --optimizer Adam --lr 0.001 --wd 0 --deterministic --compress policies/schedule_kws20.yaml --model ai85kws20net --dataset KWS_20 --confusion --enable-tensorboard --device MAX78000 "$@"

# Training Script for Cakes
python train.py --epochs 10 --optimizer Adam --lr 0.001 --wd 0 --deterministic --compress policies/schedule-cakes.yaml --model ai85cdnet --dataset cakes --confusion --param-hist --embedding --device MAX78000 "$@"
...
# Temp Train script:
# python train.py --epochs 5 --optimizer Adam --lr 0.001 --wd 0 --deterministic --compress policies/schedule-cakes.yaml --model ai85cdnet --dataset cakes --confusion --param-hist --embedding --enable-tensorboard  --device MAX78000 "$@"
